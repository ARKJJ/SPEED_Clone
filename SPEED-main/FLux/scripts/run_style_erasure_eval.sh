...
RUN_NAME="erase_${TARGET_SLUG}_to_${ANCHOR_SLUG}_${PARAMS}_fixed_t${TRACE_NUM_STEPS}"
CKPT_PATH="${CHECKPOINT_DIR}/${RUN_NAME}.safetensors"
SAVE_ROOT="${SAVE_ROOT_BASE}/style${PARAMS}"

echo "========== Erasing ${TARGET_CONCEPT} style with params=${PARAMS} =========="
