...
SAVE_ROOT_BASE="${SAVE_ROOT_BASE:-FLux/logs/FLUX_MLP}"
PYTHON_BIN="${PYTHON_BIN:-python3}"
TRACE_NUM_STEPS="${TRACE_NUM_STEPS:-10}"
THRESHOLD="${THRESHOLD:-3e-2}"
UPDATE_LAMBDA="${UPDATE_LAMBDA:-1.0}"
MODE="${MODE:-edit}"
...
run_task() {
  ...
  run_name="${erase_type}_${limited_target}_to_${anchor}_mlp_all_t${TRACE_NUM_STEPS}_thr${THRESHOLD}"
