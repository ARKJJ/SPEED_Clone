...
def main():
    ...
    parser.add_argument("--total_timesteps", type=int, default=10, help="The total timesteps of the sampling process")
    ...
    if "edit" in mode_list:
        sampled_concepts = []
        expected_count = len(template_dict[args.erase_type]) * args.num_samples
